function columnCell_Sprite(ga, name, loadCallBack)
{
    ...
    sprite.setup(ga);
    sprite.easyDefineSequence("columnCell", DOMAIN_PREFIX + "assets/Cells/column.png", 1, 1, 352, 160, 0, playInfinite);
    return sprite;
}
...
function shortColumnCell_Sprite(ga, name, loadCallBack)
{
    ...
    var sprite = new Sprite(name, "columnCell", "columnCell",loadCallBack, ga);
    sprite.setup(ga);
    sprite.easyDefineSequence("columnCell", DOMAIN_PREFIX + "assets/Cells/shortcolumn.png", 1, 1, 352, 160, 0, playInfinite);
    return sprite;
}
